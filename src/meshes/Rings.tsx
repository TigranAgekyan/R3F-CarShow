...
export default function () {
    ...
    useFrame((state) => {
        ...
        for(let i=0; i<itemsRef.current.length; i++){
            ...
            if(i%2 == 0){
                mesh.material = new MeshStandardMaterial({emissive: new Color(6,0.15,0.7).multiplyScalar(colorScale)});
            }else{
                mesh.material = new MeshStandardMaterial({emissive: new Color(0.1,0.7,3).multiplyScalar(colorScale)});
            }
        }
    })
